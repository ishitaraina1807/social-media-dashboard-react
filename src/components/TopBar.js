...
export default function TopBar() {
  const [myStyle, setMyStyle] = useState({})
      ...
      const [doStyle, setDoStyle] = useState({})
      const changeStyle = ()=>{
       if( doStyle.color === "white"){
        setDoStyle({})
       }
       else{
        setDoStyle({
    ...
    <>
      <nav className="topbar">
        ...
        <div className="mode" style={myStyle}>
          <h3>Dark Mode</h3>
          <label class="switch">
            <input style={myStyle} type="checkbox" />
            <span onClick={() => {
      toggleStyle();
      changeStyle();
      changeColor();
      ...
      <section style={{ backgroundColor: bodyColor }} className='card-container'>
      <div style={doStyle} className="fb-card">
      ...
      <div style={doStyle} className="twitter-card">
        <div className="username">
      ...
      <div style={doStyle} className="ig-card">
        <div className="username">
      ...
      <div style={doStyle} className="yt-card">
        <div className="username">
